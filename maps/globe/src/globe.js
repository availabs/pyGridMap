...
globe.init = function (container, options) {
	...
	this.map.orientation('-60, 0, 350',this.view); // Sets initial globe position
	...
	this.loadGeo({},() => {
		...
		var coastData = this.coastHi
		var lakeData = this.lakesHi
...
globe.getView = function(){
	...
	var b = document && document.getElementsByTagName(this.container)[0];
